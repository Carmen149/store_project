...
public class CommandController {
    ...
    public ResponseEntity<String> calculatePrice(@ApiParam(example = "1", value = "The command id for which the total is calculated. Cannot be empty.",type = "Long")@PathVariable Long id){
        double price=commandService.calculatePrice(id);
        return new ResponseEntity<>("The price from command " + id +" is " + price+".", HttpStatus.OK);
    }
