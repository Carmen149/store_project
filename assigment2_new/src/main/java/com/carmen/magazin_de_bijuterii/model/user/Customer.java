...
public class Customer extends User implements Comparable<Customer>{
    @NameConstraint(message = "Country name is mandatory. It should start with a capital letter and contain at least 3 characters.")
    private String country;
    @NameConstraint(message = "City name is mandatory. It should start with a capital letter and contain at least 3 characters.")
    private String city;
    @NameConstraint(message = "Street name is mandatory. It should start with a capital letter and contain at least 3 characters.")
