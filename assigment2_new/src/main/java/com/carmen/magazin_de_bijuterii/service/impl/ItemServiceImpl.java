...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public List<Item> filterList(Type type, Double priceMin, Double priceMax, Boolean availability, Integer size, String material, List<String> filters,List<Item> items) {
