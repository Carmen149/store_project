            ...
            <Table striped bordered size="sm" hover variant="dark"  >
                <thead>
                    ...
                    <tr className="text-center">
                        ...
                        <td><input type="text" id="price" size='sm'  style={{width: "130px"}}  onChange ={this.handleChange} /> </td>
                        ...
                        <td><input type="text" id="availability" size='sm'     style={{width: "100px"}}  onChange ={this.handleChange} /> </td>
                ...
                {this.state.items.map((item,i)=>(
                        <tr className='item'  key={i}>
                            ...
                            <td>{item.name}</td>
                            <td>{item.price}</td>
                            <td className="text-center"><Button variant="dark" data-toggle="modal"  onClick={()=>{this.handleShowDesc(item)}}>Show Description</Button></td>
                            <td>{item.material}</td>
